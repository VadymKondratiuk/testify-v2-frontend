...
export const myTestsMock: TestSummary[] = [
  ...
  { id: "112", title: "Introduction to Docker & Containers", status: "draft", questionsCount: 10, completions: 0, updatedAt: "2 months ago" },
];
