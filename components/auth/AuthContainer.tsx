  ...
  return (
    <div className="min-h-screen bg-[#F5F7FF] flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-[20%] right-[20%] w-10 h-10 rounded-2xl border border-[rgba(26,23,77,0.12)] rotate-10" />
      ...
      <div className="relative w-full max-w-[440px]">
        ...
        <div className="relative bg-white rounded-2xl border border-[#E2E8F0] shadow-[0_4px_24px_rgba(15,26,53,0.08),0_1px_3px_rgba(15,26,53,0.06)] p-8 sm:p-10">
          ...
          <div className="flex items-center gap-2.5 mb-8">
            ...
            <span className="font-[family-name:var(--font-sora)] font-bold text-[1.2rem] tracking-[-0.04em] text-[#0F172A]">
          ...
          {/* Heading */}
          <div className="mb-7">
            <h1 className="font-[family-name:var(--font-sora)] text-[1.65rem] font-bold text-[#0F172A] tracking-[-0.04em] leading-tight mb-1.5">
              {title}
            </h1>
